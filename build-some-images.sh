...
# 
echo "==== `date` "
echo ==== Criando imagem tsmp:$TEA_VERSION
...
for a in autoencoder dwt_mlead eif fft grammarviz3 grammarviz3_multi \
    knn lof lstm_ad numenta_htm random_black_forest robust_pca sarima \
    sr sr_cnn stamp stomp subsequence_fast_mcd subsequence_if subsequence_knn \
    subsequence_lof telemanom
do
    echo " "
    echo "===="
